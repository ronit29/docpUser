...
const routes = [
    ...
    { path: '/insurance', exact: true, component: InsuranceView, RENDER_ON_SERVER: true },
    { path: '/insurancedetails', exact: true, component: InsuranceDetails, RENDER_ON_SERVER: true },
    { path: '/insurancereviews', exact: true, component: InsuranceReview, RENDER_ON_SERVER: true },
