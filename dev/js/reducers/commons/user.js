...
export default function (state = defaultState, action) {
    ...
    switch (action.type) {
        ...
        case SET_COUPON_SPECIFIC_PAYMENT: {
            let newState = {
                ...state
            }
            newState.couponSpecificPayment = {}
            newState.couponSpecificPayment[action.orderId] = action.payload
            return newState
        }
    }
    return state
