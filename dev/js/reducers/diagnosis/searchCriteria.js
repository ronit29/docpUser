...
export default function (state = defaultState, action) {
    ...
    switch (action.type) {
        ...
        case STORE_PATIENT_DETAILS:{
            let newState = { ...state }
            newState.filled_patient_details = action.payload.criteria
            return newState
        }
