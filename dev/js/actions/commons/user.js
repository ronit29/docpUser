...
export const submitChatFeedback = (postData) => (dispatch) => {
	...
	return API_POST('api/chat/feedback/submit', postData).then(function (response) {
		dispatch({
