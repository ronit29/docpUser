...
export const getElasticCriteriaResults = (searchString, type, location, cb) => (dispatch) => {
	...
	let url = `https://l74e1dhn67.execute-api.ap-south-1.amazonaws.com/default?query=${searchString}&type=${type}&max_distance=30&lat=${location.lat}&long=${location.long}`
