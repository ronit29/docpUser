    ...
    render() {
        ...
        return (
            <div className="profile-body-wrap">
                ...
                {
                    show_dpp_organic_popup && this.state.seoFriendly && enabled_for_online_booking && landing_page && this.state.is_organic_landing && this.state.to_be_force == 1 && !STORAGE.isAgent() ?
