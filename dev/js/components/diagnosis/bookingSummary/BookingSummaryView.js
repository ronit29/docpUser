                                                    ...
                                                    <div className="col-12">
                                                        <div className="widget mrt-10">
                                                            ...
                                                            <div className="widget-content">
                                                                ...
                                                                <div className="lab-visit-time test-report">
                                                                    <h4 className="title payment-amt-label">Total Payble Amount<span><img className="info-icon-img" src="/assets/img/icons/info.svg" style={{cursor:'pointer'}} onClick={this.toggle.bind(this, 'openPaymentSummary')} /></span></h4>
