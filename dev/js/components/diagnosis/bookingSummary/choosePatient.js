    ...
    render() {
        ...
        return (
            <div className="lab-visit-time">
                <h4 className="title"><span><img src="/assets/img/icons/user.svg" style={{width: 14, marginRight: 8}} className="visit-time-icon"/></span>Patient Details <span className="float-right"><a href="#" onClick={(e) => {
                    e.preventDefault()
                    e.stopPropagation()
