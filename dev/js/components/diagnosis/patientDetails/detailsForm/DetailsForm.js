    ...
    render() {
        ...
        return (
            <div className="detailsForm">
                ...
                <input value={this.state.mobile} onChange={this.inputHandler.bind(this,'mobile')} className="ptmobile" placeholder="Mobile*" />
                ...
                <input value={this.state.patientMobile} onChange={this.inputHandler.bind(this,'patientMobile')} className="ptmobile" placeholder="Patient Mobile*" />
            </div>
