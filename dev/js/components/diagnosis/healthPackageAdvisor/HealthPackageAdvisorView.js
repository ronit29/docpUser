                                        ...
                                        return <div className="widget mb-10 mrt-10" key={key}>
                                            <div className="search-top-container">
                                                <div className="d-flex justify-content-between" style={{ alignItems: 'center' }} >
                                                    ...
                                                    <label className="container-radio mb-0 hpa-container-radio" style={{ fontSize: 12 }} onChange={self.selectCategory.bind(self, rPackages.id, true)}>Select subset <input type="radio" name={`radio_${rPackages.id}`} checked={self.state.selectCatIDs.filter(x => x.cat_id == rPackages.id && x.isSubset).length ? true : false} />
