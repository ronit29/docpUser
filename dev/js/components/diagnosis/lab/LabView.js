...

                            {
                                (this.props.LABS[lab_id] && this.props.LABS[lab_id].tests) ?
                                    <div>
                                        ...
                                        } onClick={this.bookLab.bind(this)} className="p-3 v-btn v-btn-primary btn-lg fixed horizontal bottom no-round btn-lg text-lg static-btn"><span className="text-xs selected-option static-btn" style={{ verticalAlign: 2, marginRight: 8 }}>({this.props.LABS[lab_id].tests.length} Selected) </span>Book
                                        </button>
