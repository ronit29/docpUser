...

                            {
                                (this.props.LABS[lab_id] && this.props.LABS[lab_id].tests) ?
                                    <div>
                                        ...
                                        <button disabled={
                                            this.props.currentLabSelectedTests.length < 1
                                        } onClick={this.bookLab.bind(this)} className="p-3 v-btn v-btn-primary btn-lg fixed horizontal bottom no-round btn-lg text-lg sticky-btn"><span className="text-xs selected-option static-btn" style={{ verticalAlign: 2, marginRight: 8 }}>({this.props.currentLabSelectedTests.length} Selected) </span>Book
                                        </button>
