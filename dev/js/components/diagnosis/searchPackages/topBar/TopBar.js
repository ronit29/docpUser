                        ...
                        */}
                        {
                            ...
                            :<div className="top-filter-tab-container">
                                ...
                                <img src={this.props.isCompare || this.props.compare_packages.length > 0? ASSETS_BASE_URL + "/images/packageCompare/compare-orange.png": ASSETS_BASE_URL + "/images/packageCompare/compare.png"} alt="" style={{width: 16}} /> <span className={`${this.props.isCompare || (this.props.compare_packages && this.props.compare_packages.length > 0)?'comapre-active':''}`}>Compare</span> </div>
