...
class SearchPackagesView extends React.Component {
    ...
    buildURI(state) {
        ...
        if(this.props.forSeo){
            ...
            url = `${window.location.pathname}?forTaxSaver=true&lat=${lat}&long=${long}&category_ids=5025`
        }else{
