                            ...
                            <div>
                                {
                                    cart && cart.length ? <section className="dr-profile-screen booking-confirm-screen">
                                        ...
                                        {
                                            (STORAGE.isAgent() && is_cod_applicable) ||valid_items ? <div className="fixed sticky-btn p-0 v-btn  btn-lg horizontal bottom no-round text-lg buttons-addcart-container">
