...
class CartItem extends React.Component {
    ...
    setOpdBooking(data){
        ...
        if(data.valid){
            ...
            if(data.actual_data.coupon_code){
                this.props.applyCoupons('1', {code: data.actual_data.coupon_code[0],coupon_id:data.data.coupons[0].id, is_cashback: data.coupon_cashback>0?true:false}, data.data.coupons[0].id, data.actual_data.doctor)
            }
        }
    ...
    setLabBooking(data) {
        ...
        if(data.valid){
            ...
            if(data.actual_data.coupon_code){
                this.props.applyCoupons('2', {code: data.actual_data.coupon_code[0],coupon_id:data.data.coupons[0].id, is_cashback: data.coupon_cashback>0?true:false}, data.data.coupons[0].id, data.actual_data.lab)
            }
