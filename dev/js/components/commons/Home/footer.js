                                        ...
                                        return <div className="col-12 col-md-2" style={{ marginBottom: 15, paddingTop: 10 }} key={"div" + i}>
                                            <h3 className="speciality-footer-head" onClick={() => this.toggleFooterData(i)}>{footerData.title}</h3>
                                            {
                                                screenWidth && screenWidth <= 767 ?
                                                    this.state.showFooterData.length && this.state.showFooterData.includes(i) ?
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2 col-12" key="ftr-dsktp-div-3">
                            <div className="footer-links brdr-btm-footer">
                                ...
                                {
                                    screenWidth && screenWidth <= 767 ?
                                        this.state.footerDataString.length && this.state.footerDataString.includes('doctors') ?
                                            <ul>
                        ...
                        <div className="col-md-2 col-12" key="ftr-dsktp-div-4">
                            <div className="footer-links brdr-btm-footer">
                                ...
                                {
                                    screenWidth && screenWidth <= 767 ?
                                        this.state.footerDataString.length && this.state.footerDataString.includes('labsCities') ?
                                            <ul>
                        ...
                        <div className="col-md-2 col-12" key="ftr-dsktp-div-5">
                            <div className="footer-links brdr-btm-footer">
                                ...
                                {
                                    screenWidth && screenWidth <= 767 ?
                                        this.state.footerDataString.length && this.state.footerDataString.includes('doctorsCities') ?
                                            <ul>
                        ...
                        <div className="col-md-2 col-12" key="ftr-dsktp-div-6">
                            <div className="footer-links brdr-btm-footer">
                                ...
                                {
                                    screenWidth && screenWidth <= 767 ?
                                        this.state.footerDataString.length && this.state.footerDataString.includes('resources') ?
                                            <ul>
