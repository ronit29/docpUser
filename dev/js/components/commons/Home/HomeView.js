                        ...
                        <div className="col-12 col-md-7">
                            <div className="dp-accordian">
                                <div className="acdn-title" onClick={() => this.toggleAccordian()}>
                                    <p className="fw-500">Know more about docprime</p>
                                ...
                                <div className={this.state.accordianShow ? "acdn-body mrt-10 acdn-block" : "acdn-body mrt-10 acdn-none"}>
                                    ...
                                    <h2 className="fw-500 mrb-10 acdn-heading">Free Family Doctor for Life</h2>
                                    ...
                                    <h2 className="fw-500 mrb-10 acdn-heading">docprime for Patients</h2>
                                    <p className="text-sm mrb-10">
                                        <strong>Free Online Doctor Consultation –</strong> Ask a Doctor & get answers for your health queries for free or indulge in a one-on-one online consultation, at any time and from anywhere. Simply visit our website and start interacting with best-in-class healthcare experts from various specialties.
                                    </p>
                                    <p className="text-sm mrb-10">
                                        <strong>Book Doctor Appointments Online (upto 50% off) -</strong> Why wait in long queues to book an appointment with the doctor of your choice, when you can easily do it online and that too at a much lower price?Find some of the best doctors near you; check their doctor profiles, and book an appointment online with the doctor of your choice get 50% off on booking fees, all with just a few clicks and in a matter of a few minutes.
                                    </p>
                                    <p className="text-sm mrb-10">
                                        <strong>Book Tests at Diagnostic Centres (upto 50% off) -</strong> Discover the best diagnostic centres near you from our huge inventory and book appointments at the diagnostic centre of your choice, in just a few clicks. So book diagnostic tests today and get up to 50% off.
                                    </p>
                                    <h2 className="fw-500 mrb-10 acdn-heading">docprime for Doctors</h2>
                                    <p className="text-sm mrb-10">
                                        <strong>Widen Your Reach -</strong> Are you a doctor or a healthcare expert? Use docprime to increase your visibility manifold, reach out to a wider range of patients and grow your practice without having to run from pillar to post.
                                    </p>
                                    <p className="text-sm mrb-10">
                                        <strong>Simplify Your Practice -</strong> Take the hassle out of your practice and focus better on your patients. Automate everything right from appointment management to payment tracking and just focus on providing the highest quality of treatment to their patients.
                                    </p>
                                    <h2 className="fw-500 mrb-10 acdn-heading">docprime Services</h2>
                                    <p className="text-sm mrb-10">
                                        <strong>Lab Test -</strong> Book lab test right from the comfort of your home. Get amazing discounts on lab tests and get samples collected and report delivered, right at your doorsteps.
                                    </p>
                                    <p className="text-sm mrb-10">
                                        <strong>Health Feed -</strong> Our aim to ensure a healthy lifestyle for everyone and in order to do that our knowledge-packed health feed offers information on various diseases, symptoms, and medicines.
                                    </p>
                                    <h2 className="fw-500 mrb-10 acdn-heading">Questions You May have:</h2>
                                    <p className="fw-500">Question 1: I have a medical question. Can I ask it for free?</p>
                                    <p className="text-sm mrb-10">
                                    ...
                                    <p className="fw-500">Question 2: Can doctors at docprime help me with my medical issues?</p>
                                    <p className="text-sm mrb-10">
                                    ...
                                    <p className="fw-500">Question 3: What if docprime doctors don’t get me a response?</p>
                                    <p className="text-sm mrb-10">
                                    ...
                                    <p className="fw-500">Question 4: Are doctors on your team qualified?</p>
                                    <p className="text-sm mrb-10">
                                    ...
                                    <p className="fw-500">Question 5: Is my personal information safe and is the consultation on docprime private?</p>
                                    <p className="text-sm mrb-10">
