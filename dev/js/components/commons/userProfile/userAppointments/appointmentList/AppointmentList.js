...
class AppointmentList extends React.Component {
    ...
    render() {
        ...
        let { deal_price, doctor_name, display_name, time_slot_end, time_slot_start, status, type, id, lab_name, lab_test_name, doctor_thumbnail, lab_thumbnail, patient_name, invoices, hospital_name, specialization } = this.props.data
