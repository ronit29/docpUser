            ...
            <div className="">
                ...
                <div className="p-relative gold-med-bnr covidBanner">
                    ...
                    <div className="covidBtn-cont">
                        <a target="_blank" href="https://termlife.policybazaar.com/?pb_campaign=docprime?covidPop=1 " type="button" className="med-popBtn"><span className="upName">Covid-19 covered</span>
                        <img src={ASSETS_BASE_URL + '/img/ins.svg'}/>
                        <span>Term Insurance</span> 
                        </a>
                        <a target="_blank" href="https://health.policybazaar.com/?offerid=104&utm_campaign=docprime?covidPop=1" type="button" className="med-popBtn"><span className="upName">No medical required</span> 
