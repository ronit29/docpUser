...
class LocationElementsView extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className={`row ${this.props.fromVip?'searchForVip':''}`}  style={{ backgroundColor: `var(--text--primary--color)`, marginTop: 10, position: 'relative', zIndex: 11 }} id="location_element">
