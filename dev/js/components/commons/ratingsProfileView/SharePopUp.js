...
class SharePopUp extends React.Component {
    ...
    render() {
        ...
        if (this.props.details && this.props.details.appointment_type == 2) {
            doctor_name = this.props.details.entity_name
        ...
        return (
            <div className="raiting-popup">
                <div style={{ backgroundColor: '#fff', borderRadius: 5, position: 'relative' }} >
                    ...
                    <div className="text-center mrt-20" style={{ backgroundColor: 'rgba(247, 134, R, 0.2)', padding: 10, borderBottomLeftRadius: 5, borderBottomRightRadius: 5, cursor: 'pointer' }}>
