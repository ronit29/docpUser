...
const mapStateToProps = (state) => {
    ...
    const { selectedProfile, profiles, address, userWalletBalance, userCashbackBalance, defaultProfile } = state.USER
    let LABS = state.LABS
    ...
    return {
        ...
        couponAutoApply, userWalletBalance, userCashbackBalance, pincode, defaultProfile
    }
}
