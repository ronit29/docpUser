                                     ...
                                     <div className="col-12">
                                        <div className="filter-pdng">
                                           ...
                                           <div class="filter-title">
                                              1 Results found for
                                              <h1 className="search-result-heading"><span class="fw-700"> selected categories</span></h1>
                                              <span className="search-result-span"><span class="location-edit"> in Sector 44, Gurugram</span>
