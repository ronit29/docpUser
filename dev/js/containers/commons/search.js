...
const mapStateToProps = (state) => {
    ...
    let { selectedSearchType, is_login_user_insured, profiles } = state.USER

    return { OPD_STATE, LAB_STATE, selectedSearchType, IPD_STATE, is_login_user_insured, profiles }
